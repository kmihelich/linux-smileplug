...
struct snd_pcm_ops mv88fx_pcm_ops = {
	...
	.mmap = NULL, /* Use default mmap function - snd_pcm_default_mmap */
};
...
static int mv88fx_pcm_suspend(struct snd_soc_dai_link *cpu_dai)
{
	mv88fx_snd_debug("");
...
static int mv88fx_pcm_resume(struct snd_soc_dai_link *cpu_dai)
{
	mv88fx_snd_debug("");
