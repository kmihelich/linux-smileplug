...
void __init axp_init_irq(void)
{
	...
	axp_irq_unmask(IRQ_AURORA_SOC_ERROR);
	...
	axp_irq_unmask(IRQ_AURORA_GPIO_0_7);
	axp_irq_unmask(IRQ_AURORA_GPIO_8_15);
	axp_irq_unmask(IRQ_AURORA_GPIO_16_23);
	axp_irq_unmask(IRQ_AURORA_GPIO_24_31);
	axp_irq_unmask(IRQ_AURORA_GPIO_32_39);
	axp_irq_unmask(IRQ_AURORA_GPIO_40_47);
	axp_irq_unmask(IRQ_AURORA_GPIO_48_55);
	axp_irq_unmask(IRQ_AURORA_GPIO_56_63);
	axp_irq_unmask(IRQ_AURORA_GPIO_64_66);
